<template>
    ...
    data: () => ({
        ...
        items: [
            {name: 'Lavagem Simples', price: 'R$ 60,00'},
            {name: 'Lavagem Detalhada', price: 'R$ 120,00'},
            {name: 'Polimento', price: 'R$ 450,00'},           
            {name: 'Vitrificação', price: 'R$ 1.200,00'},           
        ],
        object: null,
        Modal: null,
        choosed: null,
